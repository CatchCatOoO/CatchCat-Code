...
// Always ask when CatchCat Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by CatchCat Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by CatchCat Code)
