...
/**
 * Resolve CatchCat Code-specific path patterns for sandbox-runtime.
 *
 * CatchCat Code uses special path prefixes in permission rules:
...
/**
 * Convert CatchCat Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where CatchCat Code started)
