...
const APP_NAME = 'CatchCat Code URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'CatchCat Code URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>CatchCat Code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for CatchCat Code
