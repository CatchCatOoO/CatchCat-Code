...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when CatchCat Code was first started on this machine
  ...
  // CatchCat Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first CatchCat Code OAuth token
  ...
  // CatchCat Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
