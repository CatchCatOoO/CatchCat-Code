...
export const DESCRIPTION = 'Get or set CatchCat Code configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set CatchCat Code configuration settings.

  View or change CatchCat Code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
