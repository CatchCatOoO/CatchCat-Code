...
/**
 * Fetch the user's first CatchCat Code token date and store in config.
 * This is called after successful login to cache when they started using CatchCat Code.
 */
